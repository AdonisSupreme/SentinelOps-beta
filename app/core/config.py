...
class Settings(BaseSettings):
    ...
    NETWORK_SENTINEL_HOUSEKEEPING_INTERVAL_SECONDS: int = int(os.getenv("NETWORK_SENTINEL_HOUSEKEEPING_INTERVAL_SECONDS", "1800"))
    NETWORK_SENTINEL_RAW_RETENTION_DAYS: int = int(os.getenv("NETWORK_SENTINEL_RAW_RETENTION_DAYS", "2"))
    NETWORK_SENTINEL_SAMPLE_RETENTION_DAYS: int = int(os.getenv("NETWORK_SENTINEL_SAMPLE_RETENTION_DAYS", "14"))
    NETWORK_SENTINEL_EVENT_RETENTION_DAYS: int = int(os.getenv("NETWORK_SENTINEL_EVENT_RETENTION_DAYS", "14"))
    NETWORK_SENTINEL_OUTAGE_RETENTION_DAYS: int = int(os.getenv("NETWORK_SENTINEL_OUTAGE_RETENTION_DAYS", "14"))
    NETWORK_SENTINEL_PING_EXECUTABLE: str | None = os.getenv("NETWORK_SENTINEL_PING_EXECUTABLE")
