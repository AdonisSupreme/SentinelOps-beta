...
- FRONTEND_URL: Public frontend base URL used to build all frontend links in emails. This is required and should be set in the deployment environment or `.env`.
